...
import { selectHashlistFile } from '../features/NewTask/newTaskSlice';
    ...
    return hashlistConsumer !== null ? (
        <>
            ...
            {wireless ? (
                ...
                <label htmlFor="hashlist" className="mx-auto text-fl-sm leading-7 text-gray-600">
