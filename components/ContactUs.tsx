                    ...
                    <div className="flex flex-wrap">
                        ...
                        <div className="w-full">
                            <div className="relative">
                                ...
                                <textarea id="message" name="message" className="h-32 w-full resize-none rounded border border-gray-300 bg-gray-100 bg-opacity-50 px-3 py-1 text-base leading-6 text-gray-700 outline-none transition-colors duration-200 ease-in-out focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200" />
                            </div>
                        </div>
                        ...
                        <div className="w-full p-2">
                            <button className="mx-auto flex rounded border-0 bg-[var(--theme)] px-8 py-2 text-lg text-white transition duration-300 ease-in-out hover:bg-[var(--theme-bg)] hover:text-[var(--theme)] focus:outline-none">Submit</button>
                        </div>
                    </div>
                </div>
            </div>
